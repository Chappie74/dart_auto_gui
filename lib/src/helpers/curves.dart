...
/// See also:
///
///  * [DAGCurve], a 1D animation easing curve that starts at 0.0 and ends at 1.0.
...
/// constant rate.
///
/// A [DAGCurve] must map t=0.0 to 0.0 and t=1.0 to 1.0.
///
/// See also:
///
///  * [DAGCurves], a collection of common animation easing curves.
///  * [CurveTween], which can be used to apply a [DAGCurve] to an [Animation].
...
///    arbitrary values.
///
abstract class DAGCurve extends ParametricCurve<double> {
  /// Abstract const constructor to enable subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const DAGCurve();
  ...
  ///  * [ReverseAnimation], which reverses an [Animation] rather than a [DAGCurve].
  ///  * [CurvedAnimation], which can take a separate curve and reverse curve.
  DAGCurve get flipped => FlippedCurve(this);
}

/// The identity map over the unit interval.
///
/// See [DAGCurves.linear] for an instance of this class.
class _Linear extends DAGCurve {
  const _Linear._();
...
class SawTooth extends DAGCurve {
...
class Interval extends DAGCurve {
  /// Creates an interval curve.
  ///
  /// The arguments must not be null.
  const Interval(this.begin, this.end, {this.curve = DAGCurves.linear})
      : assert(begin != null),
        assert(end != null),
        assert(curve != null);
...
class Threshold extends DAGCurve {
...
///
/// The [DAGCurves] class contains some commonly used cubic curves:
///
///  * [DAGCurves.fastLinearToSlowEaseIn]
///  * [DAGCurves.ease]
///  * [DAGCurves.easeIn]
///  * [DAGCurves.easeInToLinear]
///  * [DAGCurves.easeInSine]
///  * [DAGCurves.easeInQuad]
///  * [DAGCurves.easeInCubic]
///  * [DAGCurves.easeInQuart]
///  * [DAGCurves.easeInQuint]
///  * [DAGCurves.easeInExpo]
///  * [DAGCurves.easeInCirc]
///  * [DAGCurves.easeInBack]
///  * [DAGCurves.easeOut]
///  * [DAGCurves.linearToEaseOut]
///  * [DAGCurves.easeOutSine]
///  * [DAGCurves.easeOutQuad]
///  * [DAGCurves.easeOutCubic]
///  * [DAGCurves.easeOutQuart]
///  * [DAGCurves.easeOutQuint]
///  * [DAGCurves.easeOutExpo]
///  * [DAGCurves.easeOutCirc]
///  * [DAGCurves.easeOutBack]
///  * [DAGCurves.easeInOut]
///  * [DAGCurves.easeInOutSine]
///  * [DAGCurves.easeInOutQuad]
///  * [DAGCurves.easeInOutCubic]
///  * [DAGCurves.easeInOutQuart]
///  * [DAGCurves.easeInOutQuint]
///  * [DAGCurves.easeInOutExpo]
///  * [DAGCurves.easeInOutCirc]
///  * [DAGCurves.easeInOutBack]
///  * [DAGCurves.fastOutSlowIn]
///  * [DAGCurves.slowMiddle]
///
...
/// See also:
///
///  * [DAGCurves], where many more predefined curves are available.
///  * [CatmullRomCurve], a curve which passes through specific values.
class Cubic extends DAGCurve {
  /// Creates a cubic curve.
  ///
  /// Rather than creating a new instance, consider using one of the common
  /// cubic curves in [DAGCurves].
  ///
...
///
/// The [DAGCurves] class contains a curve defined with this class:
/// [DAGCurves.easeInOutCubicEmphasized].
///
...
///  * [CatmullRomCurve], a curve which passes through specific values.
class ThreePointCubic extends DAGCurve {
  /// Creates two cubic curves that share a common control point.
  ///
  /// Rather than creating a new instance, consider using one of the common
  /// three-point cubic curves in [DAGCurves].
  ///
...
///
/// [Curve2D] differs from [DAGCurve] in that the values interpolated are [DAGOffset]
...
/// to the [transform] function . Unlike [DAGCurve], [Curve2D] is not required to
...
/// {@end-tool}
///
abstract class Curve2D extends ParametricCurve<DAGOffset> {
  ...
  Iterable<Curve2DSample> generateSamples({
    ...
    bool isFlat(DAGOffset p, DAGOffset q, DAGOffset r) {
      // Calculates the area of the triangle given by the three points.
      final DAGOffset pr = p - r;
      final DAGOffset qr = q - r;
  ...
  double findInverse(double x) {
    ...
    double end = 1.0;
    late double mid;
    double DAGOffsetToOrigin(double pos) => x - transform(pos).dx;
    ...
    int count = 100;
    final double startValue = DAGOffsetToOrigin(start);
    while ((end - start) / 2.0 > errorLimit && count > 0) {
      mid = (end + start) / 2.0;
      final double value = DAGOffsetToOrigin(mid);
...
class CatmullRomSpline extends Curve2D {
  ...
  CatmullRomSpline(
    List<DAGOffset> controlPoints, {
    double tension = 0.0,
    DAGOffset? startHandle,
    DAGOffset? endHandle,
  ...
  static List<List<DAGOffset>> _computeSegments(
    List<DAGOffset> controlPoints,
    double tension, {
    DAGOffset? startHandle,
    DAGOffset? endHandle,
    ...
    final List<DAGOffset> allPoints = <DAGOffset>[
      startHandle,
      ...controlPoints,
      endHandle,
    ];
    ...
    final List<List<DAGOffset>> result = <List<DAGOffset>>[];
    for (int i = 0; i < allPoints.length - 3; ++i) {
      final List<DAGOffset> curve = <DAGOffset>[
        allPoints[i],
        allPoints[i + 1],
        allPoints[i + 2],
        allPoints[i + 3]
      ];
      final DAGOffset diffCurve10 = curve[1] - curve[0];
      final DAGOffset diffCurve21 = curve[2] - curve[1];
      final DAGOffset diffCurve32 = curve[3] - curve[2];
      ...
      final DAGOffset m1 = (diffCurve21 +
              (diffCurve10 / t01 - (curve[2] - curve[0]) / (t01 + t12)) * t12) *
          reverseTension;
      final DAGOffset m2 = (diffCurve21 +
              (diffCurve32 / t23 - (curve[3] - curve[1]) / (t12 + t23)) * t12) *
          reverseTension;
      final DAGOffset sumM12 = m1 + m2;

      final List<DAGOffset> segment = <DAGOffset>[
  ...
  final List<List<DAGOffset>> _cubicSegments;

  // This is non-empty only if the _cubicSegments are being computed lazily.
  final List<DAGOffset>? _controlPoints;
  final DAGOffset? _startHandle;
  final DAGOffset? _endHandle;
  ...
  int get samplingSeed {
    _initializeIfNeeded();
    final DAGOffset seedPoint = _cubicSegments[0][1];
    return ((seedPoint.dx + seedPoint.dy) * 10000).round();
  }

  @override
  DAGOffset transformInternal(double t) {
    _initializeIfNeeded();
    ...
    final List<DAGOffset> cubicControlPoints = _cubicSegments[index];
...
class CatmullRomCurve extends DAGCurve {
  ...
  static List<Curve2DSample> _computeSamples(
      List<DAGOffset> controlPoints, double tension) {
    return CatmullRomSpline.precompute(
      // Force the first and last control points for the spline to be (0, 0)
      // and (1, 1), respectively.
      <DAGOffset>[DAGOffset.zero, ...controlPoints, const DAGOffset(1.0, 1.0)],
      tension: tension,
  ...
  ///
  /// The `dx` value of each [DAGOffset] in [controlPoints] represents the
  ...
  final List<DAGOffset> controlPoints;
  ...
  static bool validateControlPoints(
    ...
    controlPoints = <DAGOffset>[
      DAGOffset.zero,
      ...controlPoints,
      const DAGOffset(1.0, 1.0)
    ];
    final DAGOffset startHandle = controlPoints[0] * 2.0 - controlPoints[1];
    final DAGOffset endHandle =
        controlPoints.last * 2.0 - controlPoints[controlPoints.length - 2];
    controlPoints = <DAGOffset>[startHandle, ...controlPoints, endHandle];
    ...
    for (final Curve2DSample sample in samplePoints) {
      final DAGOffset point = sample.value;
  ...
  double transformInternal(double t) {
    ...
    int mid;
    DAGOffset value;
    DAGOffset startValue = _precomputedSamples[start].value;
    DAGOffset endValue = _precomputedSamples[end].value;
...
/// See also:
///
///  * [DAGCurve.flipped], which provides the [FlippedCurve] of a [DAGCurve].
///  * [ReverseAnimation], which reverses an [Animation] rather than a [DAGCurve].
///  * [CurvedAnimation], which can take a separate curve and reverse curve.
class FlippedCurve extends DAGCurve {
...
///
/// See [DAGCurves.decelerate] for an instance of this class.
class _DecelerateCurve extends DAGCurve {
...
///
/// See [DAGCurves.bounceIn] for an instance of this class.
class _BounceInCurve extends DAGCurve {
...
///
/// See [DAGCurves.bounceOut] for an instance of this class.
class _BounceOutCurve extends DAGCurve {
...
///
/// See [DAGCurves.bounceInOut] for an instance of this class.
class _BounceInOutCurve extends DAGCurve {
...
class ElasticInCurve extends DAGCurve {
  /// Creates an elastic-in curve.
  ///
  /// Rather than creating a new instance, consider using [DAGCurves.elasticIn].
...
///
/// An instance of this class using the default period of 0.4 is available as
/// [DAGCurves.elasticOut].
///
/// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_elastic_out.mp4}
class ElasticOutCurve extends DAGCurve {
  /// Creates an elastic-out curve.
  ///
  /// Rather than creating a new instance, consider using [DAGCurves.elasticOut].
...
///
/// An instance of this class using the default period of 0.4 is available as
/// [DAGCurves.elasticInOut].
///
/// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_elastic_in_out.mp4}
class ElasticInOutCurve extends DAGCurve {
  /// Creates an elastic-in-out curve.
  ///
  /// Rather than creating a new instance, consider using [DAGCurves.elasticInOut].
...
/// See also:
///
///  * [DAGCurve], the interface implemented by the constants available from the
///    [DAGCurves] class.
class DAGCurves {
  ...
  ///
  /// This is the identity map over the unit interval: its [DAGCurve.transform]
  /// method returns its input unmodified. This is useful as a default curve for
  /// cases where a [DAGCurve] is required but no actual curve is desired.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_linear.mp4}
  static const DAGCurve linear = _Linear._();
  ...
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_decelerate.mp4}
  static const DAGCurve decelerate = _DecelerateCurve._();
  ...
  /// similar to [DAGCurves.easeIn], but with sinusoidal easing for a slightly less
  /// abrupt beginning and end. Nonetheless, the result is quite gentle and is
  /// hard to distinguish from [DAGCurves.linear] at a glance.
  ///
  ...
  /// [DAGCurves.decelerate].
  ///
  /// Compared to [DAGCurves.easeInSine], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_quad.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInQuad], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_cubic.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInCubic], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_quart.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInQuart], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_quint.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInQuint], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_expo.mp4}
  ...
  ///
  /// Like [DAGCurves.easeInExpo], this curve is fairly dramatic and will reduce
  ...
  /// is similar to [DAGCurves.elasticIn] in that it overshoots its bounds before
  ...
  /// similar to [DAGCurves.easeOut], but with sinusoidal easing for a slightly
  /// less abrupt beginning and end. Nonetheless, the result is quite gentle and
  /// is hard to distinguish from [DAGCurves.linear] at a glance.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_out_sine.mp4}
  ...
  /// A cubic animation curve that starts quickly and ends slowly. This is
  /// effectively the same as [DAGCurves.decelerate], only simulated using a cubic
  /// bezier function.
  ///
  /// Compared to [DAGCurves.easeOutSine], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_out_quad.mp4}
  ...
  /// a flipped version of [DAGCurves.easeInCubic].
  ///
  ...
  ///
  /// Compared to [DAGCurves.easeOutQuad], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_out_cubic.mp4}
  ...
  /// A cubic animation curve that starts quickly and ends slowly. This curve is
  /// a flipped version of [DAGCurves.easeInQuart].
  ///
  /// Animations using this curve or steeper curves will benefit from a longer
  /// duration to avoid motion feeling unnatural.
  ///
  /// Compared to [DAGCurves.easeOutCubic], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_out_quart.mp4}
  ...
  /// A cubic animation curve that starts quickly and ends slowly. This curve is
  /// a flipped version of [DAGCurves.easeInQuint].
  ///
  /// Compared to [DAGCurves.easeOutQuart], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_out_quint.mp4}
  ...
  /// A cubic animation curve that starts quickly and ends slowly. This curve is
  /// a flipped version of [DAGCurves.easeInExpo]. Using this curve can give your
  ...
  ///
  /// Like [DAGCurves.easeOutExpo], this curve is fairly dramatic and will reduce
  /// the clarity of an animation if not given a longer duration.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  ...
  /// A cubic animation curve that starts quickly and ends slowly. This curve is
  /// similar to [DAGCurves.elasticOut] in that it overshoots its bounds before
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This is similar to [DAGCurves.easeInOut], but with sinusoidal easing
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInQuad] as the first
  /// half, and [DAGCurves.easeOutQuad] as the second.
  ///
  /// Compared to [DAGCurves.easeInOutSine], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_out_quad.mp4}
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInCubic] as the first
  /// half, and [DAGCurves.easeOutCubic] as the second.
  ///
  ...
  ///
  /// Compared to [DAGCurves.easeInOutQuad], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_out_cubic.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInOutCubic], this curve is slightly steeper.
  ///
  ...
  static const ThreePointCubic easeInOutCubicEmphasized = ThreePointCubic(
    DAGOffset(0.05, 0),
    DAGOffset(0.133333, 0.06),
    DAGOffset(0.166666, 0.4),
    DAGOffset(0.208333, 0.82),
    DAGOffset(0.25, 1),
  );

  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInQuart] as the first
  /// half, and [DAGCurves.easeOutQuart] as the second.
  ///
  /// Animations using this curve or steeper curves will benefit from a longer
  /// duration to avoid motion feeling unnatural.
  ///
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInQuint] as the first
  /// half, and [DAGCurves.easeOutQuint] as the second.
  ///
  /// Compared to [DAGCurves.easeInOutQuart], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_out_quint.mp4}
  ...
  ///
  /// Compared to [DAGCurves.easeInOutQuint], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_out_expo.mp4}
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInCirc] as the first
  /// half, and [DAGCurves.easeOutCirc] as the second.
  ///
  /// Like [DAGCurves.easeInOutExpo], this curve is fairly dramatic and will reduce
  /// the clarity of an animation if not given a longer duration.
  ///
  /// Compared to [DAGCurves.easeInOutExpo], this curve is slightly steeper.
  ///
  /// Derived from Robert Penner’s easing functions.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_ease_in_out_circ.mp4}
  ...
  /// A cubic animation curve that starts slowly, speeds up, and then ends
  /// slowly. This curve can be imagined as [DAGCurves.easeInBack] as the first
  /// half, and [DAGCurves.easeOutBack] as the second.
  ///
  ...
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_bounce_in.mp4}
  static const DAGCurve bounceIn = _BounceInCurve._();

  /// An oscillating curve that first grows and then shrink in magnitude.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_bounce_out.mp4}
  static const DAGCurve bounceOut = _BounceOutCurve._();

  /// An oscillating curve that first grows and then shrink in magnitude.
  ///
  /// {@animation 464 192 https://flutter.github.io/assets-for-api-docs/assets/animation/curve_bounce_in_out.mp4}
  static const DAGCurve bounceInOut = _BounceInOutCurve._();
